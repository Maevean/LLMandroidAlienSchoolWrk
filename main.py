...
def send_message():
    ...
    #input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Assistant: Hello, I am a phoenix from ancient China")
    input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Alien: Hello, I am a female alien from a distant star")
...
def main():
    ...
    root = tk.Tk()
    #Setting GUI title
    root.title("StarDust -v" +str(version) + " - " + todays_date)

    #Assign image as var
    image_path = "Star.png"
    image_path2 = "Bottom.gif"
    ...
    if os.path.exists(image_path):
        ...
        label2.image = photo2
        #put label on the GUI
        label2.pack(side=tk.BOTTOM, fill=tk.BOTH, expand=True)
    else:
    ...
    my_dark_blue = "#00072D"
    my_yellow = "#C5964A"
    text_area_display.config(background=my_dark_blue, foreground=my_purple, font= ("Arial", 12))
    ...
    model_path_label = tk.Label(frame_controls, text="Model Path: " + model_path, foreground=my_dark_blue, font=("Xirod", 12))
    ...
    text_area_main_user_input.config(background=my_dark_blue, foreground=my_yellow, font=("Arial", 12))
    ...
    send_button = tk.Button(root, text="Send", command=send_message, background=my_dark_blue, foreground="white", font=("Xirod", 12))
    send_button.pack()
